...
function draw() {
  ...
  if (nameSubmit == false) {
    ...
    sendPage = createA('https://kellyyy666.github.io/kellyy66.github.io/sendinfo.html?you='+you, 'Pathfinder');
    sendPage.style("font-size: 30px"); 
    sendPage.position((windowWidth/2) - 200, windowHeight*0.6);

    receivePage = createA('https://kellyyy666.github.io/kellyy66.github.io/receiveinfo.html?you='+you, 'Listener');
